...
class ZoneListTile extends StatelessWidget {
  ...
  List<Widget> _buildActions() {
    ...
    // "Mettre à jour la zone" only for zones that have partial tiles or failed.
    // Never show it for notStarted zones.
    if (map.status == OfflineMapStatus.partial || map.status == OfflineMapStatus.failed) {
      buttons.add(_actionBtn(icon: Icons.refresh, label: 'Mettre à jour la zone', color: Colors.blueAccent, onTap: onDownload));
    }
